						...
						<div class="pl-lg-6">
							<div class="row">
								<div class="col-sm-6 mb-5">
									...
									<p>
										با اعضای فعال و با تجربه جامعه Vue.js ایران آشنا شوید و روابط اجتماعی خود با متخصصان این حوزه را گسترش دهید.
									</p>
								</div>
								<div class="col-sm-6 mb-5">
									<h4 class="h5">
									...
									<p>
										از دانش برنامه نویسان فعال و با تجربه این حوزه استفاده کنید و مسائلی که تا به امروز برایتان حل نشدنی بوده اند را حل کنید.
									</p>
								</div>
							</div>
							...
							<div class="row mb-9">
								<div class="col-sm-6">
									...
									<p>
										همه افرادی که در این میتاپ شرکت می کنند با فرهنگ اشتراک گذاری پا به این رویداد میگذارند و هم می آموزند و هم آموزش می‌دهند پس  این فرصتی است برای انتقال تجارب شخصیتان به افرادی که به خوبی متوجه حرف های شما می شوند.									</p>
								</div>
								<div class="col-sm-6 mb-5">
									<h4 class="h5">
										<div class="vuejs-icon d-inline-block"></div>
									...
									<p>
										شانس شما برای یافتن یک فرصت شغلی ایده آل یا دریافت یک پروژه بزرگ به اندازه تعداد افرادی است که شما را می شناسند، پس آینده نگر باشید و شناخته شوید.									</p>
								</div>
							</div>
						</div>
					</div>
